6.1810 2025 Lecture 1: O/S overview
...
* Lectures
  * O/S ideas
  * case study of xv6, a small O/S
    read the code!
  * lab help
  * O/S papers
  * homework: answer a question about the reading, before lecture.
...
* Labs: 
  ...
  Discussion is great, but please write your own code!
    Do not look at others' solutions.

* Grading:
  50% labs, based on tests (the same tests you run).
  30% exams -- midterm in class, final during finals week.
...
* I'll show some application examples, and run them on xv6.
  ...
  xv6 small enough you'll be able to read and understand all of it.
...
* example: ex1.c, copy input to output
  ...
  how to make a new file descriptor?

* example: ex2.c, create a file
  open() creates (or opens) a file on disk,
...
* example: ex8.c, communicate between processes
  pipes combine with fork() to allow parent/child to communicate
    ...
    [diagram]
  $ ex8
  the shell builds pipelines with pipe(), fork(), exec()
